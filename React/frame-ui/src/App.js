...
import FrameGitgraph from "./FrameGitgraph";
            ...
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                    ...
                    <Container maxWidth="xl" className={classes.container}>
                        ...
                        <Paper className={classes.paper}>
                            <FrameGitgraph invalidateKey={this.state.invalidateKey} project={this.state.project} selectedCommit={this.state.commit} onUse={(commit) => { alert(commit.id) }}/>
                        </Paper>
                    </Container>
